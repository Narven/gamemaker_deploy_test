...
draw_sprite_ext(spr_pause_icon, image_index, x + 100 * image_xscale * current_button_scale, y, image_xscale * current_button_scale, image_yscale * current_button_scale, 0, current_colour_blend, _alpha_paused);